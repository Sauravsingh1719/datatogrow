      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              >
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xs lg:text-sm font-bold text-slate-800">Customer Experience</p>
                  </div>
          ...
          <div className="lg:col-span-7 flex flex-col items-center md:items-start text-center md:text-left order-2 lg:order-1">
            ...
            >
              I help Product, Operations, and CX teams turn messy data into clear decisions that <strong className="font-semibold text-slate-900"> grow orders, improve margins, and reduce churn/cancellations.</strong>
I build <strong className="font-semibold text-slate-900"> trusted metrics, scalable data models, and decision-ready dashboards</strong> that leadership can act on.
            </motion.p>
