          ...
          <section className="mb-6">
            ...
            <div className="mb-5">
              ...
              <ul className="list-disc pl-5 text-sm space-y-1 text-justify">
                [cite_start]<li>Designed and analyzed A/B tests on subscription and promo strategies, using RFM-based segmentation to tailor offers and measure impact on contribution margin and order volume[cite: 18, 19].</li>
                [cite_start]<li>Defined and executed BI Strategy converting ad-hoc asks into portfolio of self-service dashboards and data marts used daily by finance, operation and management team[cite: 20].</li>
                [cite_start]<li>Introduced Clickhouse and Superset in BI for real-time monitoring backbone and delivered 10+ interactive real-time dashboards used daily by 100+ operations and CX users[cite: 21].</li>
                [cite_start]<li>Mentored junior analysts on SQL, dashboards and metric definitions, reviewing their queries and helping standardized logic across reports[cite: 22].</li>
                [cite_start]<li>Uncovered Call Center inefficiencies (SQL, Python, Tableau) - agent performance gaps, load issues, lower shift utilization led to staffing optimization and 6% CSAT improvement[cite: 24].</li>
                [cite_start]<li>Conducted churn and retention analysis identifying high-impact segments - prioritizing fixes that reduced churn and improved customer retention by 10-12%[cite: 25].</li>
                [cite_start]<li>Designed a complex cancellation reason dataset (SQL) with ownership mapping, reduced cancellation by 10%, improved customer experience and streamlined merchant compensation flows[cite: 26].</li>
                [cite_start]<li>Identified and resolved configuration barriers that boosted daily order volume by 10-12% without additional marketing spend[cite: 27].</li>
                [cite_start]<li>Integrated LLMs (ChatGPT, Gemini) into analytics workflow for insight generation, debugging SQL/Python logic, and reduced ad-hoc turnaround time by 30-40%[cite: 28].</li>
              </ul>
            </div>
            ...
            <div className="mb-5">
              ...
              <ul className="list-disc pl-5 text-sm space-y-1 text-justify">
                [cite_start]<li>Led a team of 10 BI analysts and migrated 250+ enterprise reports to cloud infrastructure, improved speed, scalability and governance[cite: 32].</li>
                [cite_start]<li>Educated business users through Power BI training on self-service reporting, DAX usage, filters and effective visualization to maximize reporting value[cite: 33].</li>
                [cite_start]<li>Developed in-house automation tools, saved man hours and enabled additional projects without extra headcounts[cite: 34].</li>
                [cite_start]<li>Applied exploratory data analysis (EDA) on telecom network KPIs, doubling user throughput and reducing drop rate from 1% to 0.6%[cite: 35].</li>
              </ul>
            </div>
